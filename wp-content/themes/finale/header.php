...
<head>
    ...
    <link rel="stylesheet" type="text/css" media="all" href="/wp-content/lc.css" />
    <link rel="stylesheet" type="text/css" media="all" href="/wp-content/lc-mobile.css" />
    <link rel="shortcut icon" href="<?php echo get_stylesheet_directory_uri(); ?>/favicon.ico" />
    <!-- <script src="/wp-content/lc.js"></script> -->
</head>
<body>
